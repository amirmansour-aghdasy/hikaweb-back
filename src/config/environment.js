export const config = {
    ...
    ARVAN_OBJECT_STORAGE_REGION: process.env.ARVAN_OBJECT_STORAGE_REGION || 'ir-thr-at1',
    ARVAN_OBJECT_STORAGE_CUSTOM_DOMAIN: process.env.ARVAN_OBJECT_STORAGE_CUSTOM_DOMAIN, // Optional custom domain for public URLs
